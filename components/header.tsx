...
import avatarImage from '@/public/favicon.ico'
...
function MobileNavigation(
  ...
  return (
    <Popover {...props}>
      <PopoverButton className="group flex items-center rounded-full px-4 py-2 text-sm font-medium shadow-lg ring-1 shadow-zinc-800/5 backdrop-blur-sm bg-zinc-800/90 text-zinc-200 ring-white/10 hover:ring-white/20">
        Menu
        <ChevronDownIcon className="ml-3 h-auto w-2 stroke-zinc-500 group-hover:stroke-zinc-400" />
      </PopoverButton>
      <PopoverBackdrop
        transition
        className="fixed inset-0 z-50  backdrop-blur-xs duration-150 data-closed:opacity-0 data-enter:ease-out data-leave:ease-in bg-black/80"
      />
      <PopoverPanel
        focus
        transition
...
function DesktopNavigation(props: React.ComponentPropsWithoutRef<'nav'>) {
  return (
    <nav {...props}>
      <ul className="flex rounded-full px-3 text-sm font-medium shadow-lg ring-1  backdrop-blur-sm bg-zinc-800/90 text-zinc-200 ring-white/10">
